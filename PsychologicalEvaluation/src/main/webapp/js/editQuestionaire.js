...
/*					 	var options = $(".choiceoption").eq(i).children().map(function() {
					...
					if(save){
						//用ajax请求服务器保存数据
						jsonString = JSON.stringify(questionaire);
						//jsonString = '{"title":"测测你能否拥有“诗和远方”","description":"“生活不只是眼前的苟且，还有诗和远方。”当理想被现实无情践踏，你是否还能越过眼前的苟且，看到属于你的诗和远方？","choiceQuestions":[{"question":"1. 对于用的东西,你会比较讲究吗?","vector":"0","options":"是,一般,不是","scores":"1,2,3"},{"question":"2. 你会因为外表而对人产生偏见喜好么?","vector":"0","options":"是,一般,不是","scores":"1,2,3"},{"question":"3. 你觉得自己的历史还算不错?","vector":"0","options":"是,一般,不是","scores":"1,2,3"},{"question":"4. 你常常在某段时间,觉得自己特颓废?","vector":"0","options":"是,一般,不是","scores":"1,2,3"},{"question":"5. 现在朋友找你聊心事,你会耐心倾听吗?","vector":"0","options":"是,一般,不是","scores":"1,2,3"},{"question":"6. 下面三个女明星,你最喜欢的是?","vector":"0","options":"林青霞,王祖贤,张曼玉","scores":"1,2,3"},{"question":"7. 有三天假,你觉得下面哪件事最有意义?","vector":"0","options":"短途旅行,出门锻炼,宅家看书","scores":"1,2,3"},{"question":"8. 失恋了,让你选择存放在冰箱的食物吃,你会首先吃?","vector":"0","options":"啤酒,冰淇淋,鸭脖子","scores":"1,2,3"},{"question":"9. 如果用下面一种水果来形容你自己,你会用?","vector":"0","options":"葡萄,苹果,榴莲","scores":"1,2,3"},{"question":"10. 如果你是一种花,下面的颜色,你最喜欢做什么色的花?","vector":"0","options":"红,黄,白","scores":"1,2,3"}]}';
